...
| # | Challenge | Konzept |
|---|-----------|---------|
| 6.1 | [Evalite Basics](/de/level-6-evals/02-evalite-basics/) | Installation, `.eval.ts` Dateikonvention, evalite() Grundstruktur |
| 6.2 | [Deterministic Eval](/de/level-6-evals/03-deterministic-eval/) | Inline Scorer, createScorer, Levenshtein, Contains-Check |
| 6.3 | [LLM-as-a-Judge](/de/level-6-evals/04-llm-as-judge/) | Factuality Scorer, Score-Skala A-E, Rationale |
| 6.4 | [Dataset Management](/de/level-6-evals/05-dataset-management/) | Repraesentative Datasets, Edge Cases, Dataset Critiquing |
| 6.5 | [Langfuse Basics](/de/level-6-evals/06-langfuse/) | Traces, Generations, Scores, Production-Monitoring |
