...
description: "Verstehe Production-Observability für LLM-Anwendungen — Traces, Generations, Scores und Echtzeit-Monitoring mit Langfuse."
sidebar:
  order: 6
---
...
<Image src={overviewDiagram} alt="Production App sendet LLM Call, der in einem Langfuse Trace erfasst wird, der im Dashboard Latenz, Kosten und Qualität anzeigt" />
...
|---------|--------------|
| **Traces** | Alle Requests mit Timeline — klicke rein für Details |
| **Generations** | Jeder LLM-Call mit Input, Output, Tokens, Latenz |
| **Scores** | Durchschnittliche Qualität über die Zeit |
...
<Image src={workflowDiagram} alt="Development-Loop: Code ändern, Evalite (Lokale Evals), Score vergleichen, zurück zu Code. Production-Loop: App, Langfuse Monitoring, Alerts bei Score-Drop, die Code-Aenderungen ausloesen" />
...
<Image src={combineDiagram} alt="Development fuehrt zu Evalite (6.1-6.4), dann Prompt verbessern, Deploy, Langfuse (6.5), Monitoring — bei sinkendem Score fuehrt der Weg zurück zu Development" />
...
Neben Langfuse gibt es weitere Observability-Tools für LLM-Anwendungen, z.B. [Braintrust](https://braintrust.dev), [LangSmith](https://smith.langchain.com) oder [Weights & Biases Weave](https://wandb.ai/site/weave). Die Konzepte (Traces, Spans, Scores) sind aehnlich — wenn Du eines verstehst, findest Du Dich in den anderen schnell zurecht.
:::
