...
<Image src={overviewDiagram} alt="Production App sendet LLM Call, der in einem Langfuse Trace erfasst wird, der im Dashboard Latenz, Kosten und Qualitaet anzeigt" />
...
<Image src={workflowDiagram} alt="Development-Loop: Code aendern, Evalite (Lokale Evals), Score vergleichen, zurueck zu Code. Production-Loop: App, Langfuse Monitoring, Alerts bei Score-Drop, die Code-Aenderungen ausloesen" />
...
<Image src={combineDiagram} alt="Development fuehrt zu Evalite (6.1-6.4), dann Prompt verbessern, Deploy, Langfuse (6.5), Monitoring — bei sinkendem Score fuehrt der Weg zurueck zu Development" />
