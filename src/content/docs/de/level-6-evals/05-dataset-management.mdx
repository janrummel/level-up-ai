...
<Image src={overviewDiagram} alt="Dataset-Management-Zyklus: Seed Data sammeln, Evaluate ausfuehren, Critique (Daten bewerten), Improve (Daten ergaenzen) fuehrt zurueck zu Evaluate — ein iterativer Kreislauf zur Verbesserung der Test-Daten" />
