...
| `totalUsage` | Nicht verfÃ¼gbar | Aggregiert Ã¼ber alle Schritte |
| `steps` | Nicht verfÃ¼gbar | Array aller Schritte |
| `stepType` | `'initial'`, `'continue'`, `'tool-result'` | Nicht verfÃ¼gbar |
| `isContinued` | `true` wenn der nÃ¤chste Schritt folgt | Nicht verfÃ¼gbar |
