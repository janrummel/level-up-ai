...
- [Challenge 7.1: Custom Data Parts](../../level-7-streaming/02-custom-data-parts/) — Streaming-Grundlagen
- [Challenge 8.1: Workflows](../../level-8-workflows/02-workflow/) — Multi-Step Workflows mit kombinierten Streams
