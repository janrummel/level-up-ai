...
`needsApproval` (boolean oder Funktion) aktiviert das Tool-Approval-Pattern — siehe [Tool Approval](../../level-3-agents/06-tool-approval/). Für `outputSchema` und `title` pruefe die [offizielle tool()-Referenz](https://ai-sdk.dev/docs/reference/ai-sdk-core/tool).
:::
