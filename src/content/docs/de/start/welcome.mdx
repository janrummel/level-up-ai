...
Dieser Kurs basiert auf dem Vercel AI SDK v6.x (Stand Maerz 2026). APIs entwickeln sich weiter — pruefe im Zweifelsfall die aktuelle Dokumentation auf [ai-sdk.dev](https://ai-sdk.dev). Die Prinzipien und Patterns bleiben stabil auch wenn APIs sich ändern.
</details>

## Verwandtes Projekt

<LinkCard title="AI Product Thinking" href="https://janrummel.github.io/ai-product-thinking/" description="Das Gegenstueck für Product Manager: ein kostenloser AI PM Lernpfad mit Entscheidungsszenarien statt Code. Gleiche Qualität, andere Perspektive." />
