...
description: "Human-in-the-Loop für kritische Operationen — mit needsApproval, dynamischer Approval-Logik und sicheren Agents."
sidebar:
  order: 6
---
...
<Image src={overviewDiagram} alt="LLM will Tool ausführen, Approval Guard fragt User, bei Genehmigung wird Tool ausgefuehrt, bei Ablehnung abgelehnt" />
...
<Image src={combineDiagram} alt="Prompt startet Agent, LLM waehlt sichere oder gefaehrliche Tools, gefaehrliche brauchen Approval, bei Ablehnung zurück zum LLM" />
