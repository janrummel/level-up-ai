...
> Falls noch nicht installiert: `npm install zod`. Zod ist eine TypeScript-first Schema-Validierungs-Library — Du definierst die erwartete Struktur, und Zod sorgt fuer Typensicherheit zur Compile- und Laufzeit.
