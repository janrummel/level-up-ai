...
<Image src={overviewDiagram} alt="Entscheidungsbaum fuer die Modell-Auswahl: Einfache Aufgaben nutzen Flash/Haiku, Standard nutzt Balanced, Komplexe nutzt Frontier-Modelle" />
