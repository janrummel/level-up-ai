...
graph TD
  subgraph HIER["Du bist HIER: Modell-Auswahl"]
    ...
    Aufgabe --> Code{"Code?"}
    Einfach -->|Ja| Flash["Flash-Modell<br/>guenstig, schnell<br/>gemini-2.5-flash"]
    Komplex -->|Ja| Pro["Pro-Modell<br/>teurer, besser<br/>claude-sonnet-4-5-20250514"]
    Code -->|Ja| CodeModel["Code-Modell<br/>spezialisiert<br/>z.B. claude-sonnet"]
  end
...
Die Modell-Auswahl ist eine bewusste Entscheidung: Welches Modell passt zu welcher Aufgabe? Das AI SDK macht den Wechsel trivial — nur Import und Model-Zeile aendern sich.
...
**Mit bewusster Modell-Wahl:** Du nutzt das optimale Modell fuer jede Aufgabe. Flash-Modelle fuer einfache Tasks, Pro-Modelle fuer komplexe. Das AI SDK macht den Wechsel so einfach, dass Du verschiedene Modelle in einer Anwendung mischen kannst.
...
graph TD
  ...
  Select --> Simple["Flash-Modell"]
  Select --> Complex["Pro-Modell"]
