...
**Mit `onFinish`:** Das Speichern passiert automatisch, direkt nachdem das LLM fertig ist. Der Callback wird nach erfolgreicher Completion aufgerufen. Du hast einen zentralen Ort fuer Logging, Analytics und Persistence.
...
Der Callback bekommt ein Objekt mit den wichtigsten Properties (die vollstaendige Liste findest Du in der [generateText API Reference](https://ai-sdk.dev/docs/reference/ai-sdk-core/generate-text)):
