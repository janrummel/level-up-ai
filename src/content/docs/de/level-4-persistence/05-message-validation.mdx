...
Zod definiert die erwartete Struktur einer Message:
...
### Schicht 4: Injection-Schutz Basics

Validation schuetzt auch vor einfachen Injection-Versuchen:
...
**Wichtig:** String-basierte Injection-Checks sind ein erster Schritt, aber kein vollstaendiger Schutz. In Production brauchst Du zusaetzlich Rate Limiting, Content Moderation APIs und Output-Validation. Aber fuer den Einstieg ist das Prinzip klar: Validate first, process second.
