...
| # | Challenge | Konzept |
|---|-----------|---------|
| 4.1 | [On Finish](/de/level-4-persistence/02-on-finish/) | `onFinish` Callback, automatisches Speichern nach Completion |
| 4.2 | [Chat ID](/de/level-4-persistence/03-chat-id/) | Session-Management, Chat-Zuordnung per ID |
| 4.3 | [Persistence](/de/level-4-persistence/04-persistence/) | Messages speichern, laden, Chat fortsetzen |
| 4.4 | [Message Validation](/de/level-4-persistence/05-message-validation/) | Zod Schema, Validation vor dem Speichern |
