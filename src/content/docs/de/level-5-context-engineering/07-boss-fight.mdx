...
Du baust einen **Documentation Assistant** — ein AI-System, das technische Dokumentation analysiert und Entwickler-Fragen beantwortet. Der Assistant muss zuverlÃ¤ssig arbeiten: quellenbasierte Antworten, konsistentes Format, nachvollziehbarer Denkprozess. Keine Halluzinationen.
...
6. `streamText` fÃ¼r die Ausgabe ins Terminal
...
// 3. Exemplars — mindestens 2 Beispiele fÃ¼r das Antwort-Format
