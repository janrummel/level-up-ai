...
<LessonIllustration src={illustration} alt="Level 5: Context Engineering — den Kontext fuer ein LLM optimal gestalten" />
...
> **Projektverzeichnis:** Du arbeitest weiterhin im Projektverzeichnis aus Level 1. Erstelle fuer jede Challenge eine eigene TypeScript-Datei (z.B. `challenge-5-1.ts`).
