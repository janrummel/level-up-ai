...
- **Context Window:** Alles was zum LLM geht — System Prompt, Messages, Tool-Definitionen UND Platz fÃ¼r Output — muss ins Context Window passen. Bei Ueberschreitung: Fehler oder stille Truncation. Strategien: Message-Truncation, Token-Budget, Summarization.
- **Prompt Caching:** Identische Prompt-Prefixe werden nach dem ersten Request aus dem Cache gelesen — bei Anthropic zu 10% der normalen Input-Kosten. Cache-Hit-Rate tracken fÃ¼r Kostenoptimierung.

## Aktualisierter Skill Tree

<Image src={skillTree} alt="Skill Tree — Level 2 LLM Fundamentals abgeschlossen, Level 3 Agents & MCP ist das nÃ¤chste Level" />
