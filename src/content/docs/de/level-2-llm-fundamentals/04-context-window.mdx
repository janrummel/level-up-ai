...
<Image src={overviewDiagram} alt="Context Window enthaelt System Prompt, Messages, Tool-Definitionen und Platz fuer Output; bei Ueberschreitung Fehler oder Truncation" />
