...
Die TTL (Time To Live) wird bei jedem Cache-Hit erneuert. Solange regelmaessig Requests mit demselben Prefix kommen, bleibt der Cache aktiv. Erst wenn 5 Minuten (Anthropic) ohne Cache-Hit vergehen, verfaellt der Cache.
:::
