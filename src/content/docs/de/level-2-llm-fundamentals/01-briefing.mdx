...
| # | Challenge | Konzept |
|---|-----------|---------|
| 2.1 | [Tokens](/de/level-2-llm-fundamentals/02-tokens/) | Was Tokens sind, wie Tokenisierung funktioniert, Token-Counting |
| 2.2 | [Usage Tracking](/de/level-2-llm-fundamentals/03-usage-tracking/) | `result.usage`, Kostenberechnung, Extended Usage Details |
| 2.3 | [Context Window](/de/level-2-llm-fundamentals/04-context-window/) | Context-Window-Groessen, was reinzaehlt, Strategien bei vollem Fenster |
| 2.4 | [Prompt Caching](/de/level-2-llm-fundamentals/05-prompt-caching/) | Cache-Mechanik, `cacheReadTokens`, Kosten-Reduktion |
