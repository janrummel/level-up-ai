...
description: "Waehle automatisch das richtige Modell für jede Aufgabe — guenstig für Einfaches, stark für Komplexes, spezialisiert für Code."
sidebar:
  order: 3
---
...
Modellpreise ändern sich regelmäßig — pruefe die aktuellen Preise auf den jeweiligen Provider-Seiten ([Anthropic](https://docs.anthropic.com/en/docs/about-claude/models), [Google AI](https://ai.google.dev/gemini-api/docs/models)) bevor Du Kosten kalkulierst.
:::
