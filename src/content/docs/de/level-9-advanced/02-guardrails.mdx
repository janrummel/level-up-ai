...
> **Production-Hinweis:** Diese Keyword-basierten Checks sind ein Startpunkt. In Production nutzt Du ML-basierte Classifier oder spezialisierte APIs (z.B. OpenAI Moderation API) fuer robustere Erkennung.
