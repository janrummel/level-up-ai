...
description: "Du hast alle 9 Levels gemeistert. Vom Vibe Coder zum AI Engineer — der komplette Skill Tree, Abschluss und nÃ¤chste Schritte."
sidebar:
  order: 7
  badge:
    text: 'Complete'
...
- **Model Router:** Automatisch das richtige Modell fÃ¼r jede Aufgabe waehlen — von einfacher Switch-Logik Ã¼ber Token-basiertes Routing bis zu LLM-basierter Klassifikation. Das Ergebnis: gleiche QualitÃ¤t bei bis zu 90% niedrigeren Kosten.
...
| Ein Modell fÃ¼r alles | Routet zum optimalen Modell |
| "Funktioniert irgendwie" | Evals beweisen die QualitÃ¤t |
...
- **[ai-sdk.dev](https://ai-sdk.dev)** — Die offizielle AI SDK Dokumentation. Deine erste Anlaufstelle fÃ¼r neue Features, API-Referenzen und Guides.
- **[docs.anthropic.com](https://docs.anthropic.com)** — Anthropic's Dokumentation fÃ¼r Claude. Prompt Engineering, Best Practices, API-Referenz.
- **[platform.openai.com](https://platform.openai.com/docs)** — OpenAI's Plattform-Dokumentation. Models, API, Best Practices.
- **[ai.google.dev](https://ai.google.dev)** — Google AI Dokumentation fÃ¼r Gemini. Models, API, Tutorials.

### Tools und Frameworks

- **[Evalite](https://www.evalite.dev)** — Das Eval-Framework das Du in Level 6 gelernt hast. FÃ¼r systematische Qualitaetssicherung.
- **[Zod](https://zod.dev)** — Schema Validation fÃ¼r TypeScript. Die Basis fÃ¼r Structured Output und Tool Parameters.
- **[MCP (Model Context Protocol)](https://modelcontextprotocol.io)** — Der Standard fÃ¼r Tool-Integration, den Du in Level 3 kennengelernt hast.
...
4. **Content Pipeline** — Ein System das Blog-Posts generiert: Research, Outline, Draft, Edit, Format. Nutze Workflows (Level 8) mit Evals (Level 6) fÃ¼r Qualitaetssicherung.
