...
7. **Streaming** (Level 7 + 8.2) — Streame den finalen Report in Echtzeit. Sende Progress Data Parts fuer jede Phase der Pipeline. (Nutze `createDataStream` + `writeData` wie in Challenge 8.2.)
