...
<CardGrid>
  <LinkCard title="9.1 — Guardrails" description="Input-Checks (Injection, PII), Output-Checks (Toxicity, Format), Middleware-Pattern" href="/de/level-9-advanced/02-guardrails/" />
  <LinkCard title="9.2 — Model Router" description="Aufgabenklassifikation, dynamisches Routing, Kostenoptimierung" href="/de/level-9-advanced/03-model-router/" />
  <LinkCard title="9.3 — Comparing Outputs" description="Parallele Modell-Aufrufe, LLM-as-a-Judge, systematischer Vergleich" href="/de/level-9-advanced/04-comparing-outputs/" />
  <LinkCard title="9.4 — Research Workflow" description="End-to-End Pipeline, alle Konzepte vereint, Production-Ready" href="/de/level-9-advanced/05-research-workflow/" />
</CardGrid>
