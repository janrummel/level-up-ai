...
**Aufgabe:** Baue eine API Route, die per `createDataStream` einen Status ("searching", "analyzing", "done") UND den LLM-Stream sendet. Konsumiere die Data Parts mit `fullStream`.
