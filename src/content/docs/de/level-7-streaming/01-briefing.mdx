...
description: "Fortgeschrittenes Streaming — Custom Data Parts, Message Metadata, Stream Transforms und Error Handling für Production-Apps."
sidebar:
  order: 1
  badge:
    text: 'Advanced'
...
<LessonIllustration src={illustration} alt="Level 7: Streaming — fortgeschrittenes Streaming für Production-Apps" />
