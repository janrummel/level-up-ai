...
> **Projektverzeichnis:** Erstelle einen neuen Ordner `level-8-workflows/` fuer die Dateien dieses Levels. Du brauchst keine neuen Pakete — `ai`, `@ai-sdk/anthropic` und `zod` aus vorherigen Levels genuegen.
...
<CardGrid>
  ...
  <LinkCard title="8.2 — Streaming to Frontend" description="`createDataStream` + `writeData` fuer Step-Fortschritt, Frontend-Konsum" href="../03-streaming-to-frontend/" />
