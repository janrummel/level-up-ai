...
- [Challenge 1.4: Streaming Text](../../level-1-ai-sdk-basics/05-streaming-text/) -- first streaming exercise
- [Level 7: Production Streaming](../../level-7-streaming/01-briefing/) -- advanced streaming patterns
