...
- [Challenge 7.1: Custom Data Parts](/en/level-7-streaming/02-custom-data-parts/) -- stream writing basics
- [Challenge 8.1: Workflow](/en/level-8-workflows/02-workflow/) -- combining multiple LLM calls
