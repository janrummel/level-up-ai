...
- [Custom Data Parts Streaming](/en/reference/04-custom-data-parts-streaming/) -- server-side fundamentals
- [Custom Data Parts in the Frontend](/en/reference/05-custom-data-parts-frontend/) -- rendering data parts
- [Challenge 7.1: Custom Data Parts](/en/level-7-streaming/02-custom-data-parts/) -- hands-on exercise
- [Challenge 8.2: Streaming to Frontend](/en/level-8-workflows/03-streaming-to-frontend/) -- workflow streaming
