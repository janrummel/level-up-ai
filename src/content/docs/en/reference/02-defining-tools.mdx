...
- [Challenge 3.1: Tool Calling](../../level-3-agents/02-tool-calling/) -- hands-on tool definition and usage
- [Challenge 3.4: Tool Loop Agent](../../level-3-agents/04-tool-loop-agent/) -- multi-step tool usage with `maxSteps`
