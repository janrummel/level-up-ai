...
- [Challenge 3.4: Tool Loop Agent](/en/level-3-agents/04-tool-loop-agent/) -- multi-step tool calling with `maxSteps`
- [Level 8: Workflows](/en/level-8-workflows/01-briefing/) -- orchestrating multi-step generation
