...
- [Challenge 1.3: Generating Text](../../level-1-ai-sdk-basics/04-generating-text/) -- result object and message handling
- [Challenge 4.3: Persistence](../../level-4-persistence/04-persistence/) -- storing and restoring UIMessages
