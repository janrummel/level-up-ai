...
- [Custom Data Parts in the Frontend](/en/reference/05-custom-data-parts-frontend/) -- consuming data parts with `useChat`
- [Custom Data Parts: ID Reconciliation](/en/reference/06-custom-data-parts-id-reconciliation/) -- progressive updates
