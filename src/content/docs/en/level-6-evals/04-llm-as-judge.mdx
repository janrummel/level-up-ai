...
| **E** | Irrelevant | 0.0 | Answer has nothing to do with the question |
...
The scorer uses `generateObject` from the AI SDK to get a structured evaluation from the judge LLM:
