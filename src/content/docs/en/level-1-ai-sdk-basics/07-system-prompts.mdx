...
You already know the `system` parameter from Challenge 1.3, where you used it for the first time. But what exactly is the difference between a system prompt and a user prompt? Who "hears" which — and how do you design it for consistent behavior?

## OVERVIEW

<Image src={overviewDiagram} alt="System prompt with role, rules and style plus the user prompt flow into the LLM, output: response in the defined style" />
...
========================================
Oh, a REST API? That's like HTTP, except that...

========================================
System: Du bist ein Tech-Journalist.
========================================
## What is a REST API?
A REST API is an architectural pattern...
```
...
<Image src={combineDiagram} alt="System Prompt and User Input flow into generateText, then Output.object to structured feedback with score, issues, suggestions" />
