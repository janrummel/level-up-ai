...
<Image src={overviewDiagram} alt="AI SDK architecture: Your code connects through AI SDK Core, UI and RSC to providers like Anthropic, OpenAI and Google" />
...
<Image src={combineDiagram} alt="The same prompt is sent to generateText with Anthropic and OpenAI, producing two separate outputs" />
