...
```mermaid
graph LR
  Q["User Question"] --> R["Search External<br/>Source"]
  subgraph HIER["You are HERE: Retrieval"]
    R --> F["Find Relevant<br/>Data"]
    F --> P["Insert into Prompt<br/>&lt;background-data&gt;"]
  end
  P --> LLM["LLM answers"]
  LLM --> A["Source-based<br/>Answer"]
  Q -.-> NOPE["Without RAG:<br/>Hallucination"]
...
graph LR
  ...
  Call --> Output["Source-based<br/>Answer"]
