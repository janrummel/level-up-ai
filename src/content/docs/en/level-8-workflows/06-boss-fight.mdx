...
<Image src={l8BossOverview} alt="Boss Fight Overview: Topic as input, Research Loop with Break Conditions in Step 1, Summarize in Step 2, Format in Step 3, createDataStream delivers everything to Frontend" />
