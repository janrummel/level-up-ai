...
<Image src={l8C3Overview} alt="Overview: Initialize as input, Custom Loop with generateText, finishReason check and messages update as process, Return result as output" />
...
<Image src={l8C3Combine} alt="Combine: User Prompt into Custom Loop with generateText and State Tracking, then createDataStream with Progress and Frontend output" />
