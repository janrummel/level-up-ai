...
<CardGrid>
  <LinkCard title="8.1 — Workflow" description="Sequential generateText calls, output chaining, specialized steps" href="/en/level-8-workflows/02-workflow/" />
  <LinkCard title="8.2 — Streaming to Frontend" description="createDataStream + writeData for step progress, frontend consumption" href="/en/level-8-workflows/03-streaming-to-frontend/" />
  <LinkCard title="8.3 — Custom Loop" description="Custom while loop, messages array, state tracking, finishReason check" href="/en/level-8-workflows/04-custom-loop/" />
  <LinkCard title="8.4 — Breaking the Loop" description="Max iterations, timeout, cost guard, quality check, partial results" href="/en/level-8-workflows/05-breaking-the-loop/" />
</CardGrid>
