...
<Image src={l8C4Overview} alt="Overview: Agent Loop running, Break Conditions check Max Iterations, Timeout, Cost Guard and Quality Check, on limit Break with Partial Result, on success Return Result" />
...
<Image src={l8C4Combine} alt="Combine: User Prompt into Robust Agent Loop with generateText, Break Conditions and State Tracking, terminate yields Partial Result, done yields Final Result" />
