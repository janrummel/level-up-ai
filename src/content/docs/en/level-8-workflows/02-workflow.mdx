...
<Image src={l8C1Overview} alt="Overview: Topic as input, three chained steps (Research, Summarize, Format) as process, Final Output" />
...
<Image src={l8C1Combine} alt="Combine: Topic and System Prompts (Research, Analyst, Writer) as inputs to three steps, Result as output" />
