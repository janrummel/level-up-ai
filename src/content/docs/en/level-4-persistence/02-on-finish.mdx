...
<Image src={overviewDiagram} alt="prompt flows to generateText, onFinish callback sends to DB/logging and response" />
...
<Image src={timingDiagram} alt="generateText starts, LLM generates, completion finished, onFinish fires, await resolved" />
...
<Image src={combineDiagram} alt="prompt flows to generateText, onFinish sends to usage tracker and audit log, result.text as output" />
