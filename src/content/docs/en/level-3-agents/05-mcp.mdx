...
<Image src={overviewDiagram} alt="AI app connects via MCP client and protocol to three MCP servers for files, database and web API" />
...
<Image src={combineDiagram} alt="Prompt flows to generateText, tool loop chooses between MCP client and local tool, MCP connects to server" />
