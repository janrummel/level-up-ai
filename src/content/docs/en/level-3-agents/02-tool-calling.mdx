...
<Image src={combineDiagram} alt="System prompt and user prompt flow to generateText, tool call decision, execute returns tool result, or directly result.text" />
