...
<Image src={overviewDiagram} alt="User input starts research agent: LLM uses tool loop with search, summarize and save (with approval), formatted output at end" />
