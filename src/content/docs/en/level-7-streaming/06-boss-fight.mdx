...
<Image src={l7BossOverview} alt="Boss Fight Architecture: User Query with Metadata flows via API Route to createDataStream and streamText with Transforms and Error Handler into Dashboard UI" />
