...
<Image src={overviewDiagram} alt="Frontend, API route and LLM stream text-deltas with custom data parts for progress display" />
...
<Image src={l7C1Combine} alt="Combine: User Prompt and Status Parts flow through streamText() and createDataStream() into the Frontend UI" />
