...
<Image src={l9C3Overview} alt="Overview: Same Prompt to Model A, B, C (all process in group), all to Judge LLM, then to Best Output" />
...
<Image src={l9C3Combine} alt="Combine: Prompt to Parallel Calls, then to Result A, B, C, all to Evalite Scorer, then to Comparison Report" />
