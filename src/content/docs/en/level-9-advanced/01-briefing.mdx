...
| # | Challenge | Concept |
|---|-----------|---------|
| 9.1 | [Guardrails](/en/level-9-advanced/02-guardrails/) | Input checks (injection, PII), output checks (toxicity, format), middleware pattern |
| 9.2 | [Model Router](/en/level-9-advanced/03-model-router/) | Task classification, dynamic routing, cost optimization |
| 9.3 | [Comparing Outputs](/en/level-9-advanced/04-comparing-outputs/) | Parallel model calls, LLM-as-a-Judge, systematic comparison |
| 9.4 | [Research Workflow](/en/level-9-advanced/05-research-workflow/) | End-to-end pipeline, all concepts combined, production-ready |
