...
<Image src={overviewDiagram} alt="Text is tokenized to IDs, LLM processes them, detokenizer produces output text" />
...
<Image src={combineDiagram} alt="Task flows to selectModel to model, generateText returns result.usage, token comparison" />
