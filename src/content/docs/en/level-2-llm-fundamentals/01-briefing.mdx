...
<CardGrid>
  <LinkCard title="2.1 — Tokens" description="What tokens are, how tokenization works, token counting" href="/en/level-2-llm-fundamentals/02-tokens/" />
  <LinkCard title="2.2 — Usage Tracking" description="result.usage, cost calculation, Extended Usage Details" href="/en/level-2-llm-fundamentals/03-usage-tracking/" />
  <LinkCard title="2.3 — Context Window" description="Context window sizes, what counts toward it, strategies for a full window" href="/en/level-2-llm-fundamentals/04-context-window/" />
  <LinkCard title="2.4 — Prompt Caching" description="Cache mechanics, cacheReadTokens, cost reduction" href="/en/level-2-llm-fundamentals/05-prompt-caching/" />
</CardGrid>
